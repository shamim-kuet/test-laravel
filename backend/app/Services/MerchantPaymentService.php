...
class MerchantPaymentService
{
    ...
    {
        try {
            $response = $this->curl->send('GET', 'merchantpayment', '', '', 'display');
            //  dd($response);
    ...
    public function create($inputs)
    {
        ...
        try {
            // dd($inputs);
            $response = $this->curl->send('POST', 'merchantpayment/store', '', $inputs, 'insert');
            // dd($response);
            if ($response->success == true) {
    ...
    public function update($inputs)
    {
        ...
        //dd($inputs);
        try {
            $response = $this->curl->send('POST', 'merchantpayment/update', '', json_encode($inputs), 'update');
            //dd($response);
            if ($response->success == true) {
                $data = array('status' => true, 'message' => $response->message);
                return $data;
