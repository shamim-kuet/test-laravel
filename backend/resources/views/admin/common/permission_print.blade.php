                    ...
                    @if ($getResponse->data != '')
                        @foreach ($getResponse->data as $response)
                            <tr>
                                ...
                                <td>{{ date('Y-m-d H:i:s', strtotime(\Utility::commonDateFormate($response->created_at))) }}</td>
                                <td>{{ date('Y-m-d H:i:s', strtotime(\Utility::commonDateFormate($response->updated_at))) }}</td>
                            </tr>
                        @endforeach
                    @endif
                </tbody>
