                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                ...
                                <div class="right">
                                    <a class="btn btn-primary btn-learge" href="{{ route('codcharge.index') }}"><i
                                            data-feather='eye'></i> View COD Charge</a>
                                    <a class="btn btn-dark btn-learge" href="{{ route('codcharge.create') }}"><i
                        ...
                        <section class="modern-horizontal-wizard card bg-light">
                            <div class="bs-stepper wizard-modern modern-wizard-example">
                                ...
                                <form action="{{ route('codcharge.update', $codcharge->id) }}" method="post"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" id="modern-name" name="name" class="form-control"
                                                    value="{{ $codcharge->percentage }}"
                                                    placeholder="Ex: Banani, Mirpur" />
                                            </div>
