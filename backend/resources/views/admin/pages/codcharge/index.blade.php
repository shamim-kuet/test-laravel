        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">COD Charge</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item active">COD Charge</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                                        ...
                                        <ol class="breadcrumb float-sm-right">
                                            <li style="margin: 2px;">
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('common.export', ['extension' => 'csv', 'type' => 'codcharge']) }}">
                                                    <i data-feather='file-text'></i> CSV</a>
                                            </li>
                                            <li style="margin: 2px;">
                                                <a class="btn btn-secondary btn-sm"
                                                    href="{{ route('common.export', ['extension' => 'xlsx', 'type' => 'codcharge']) }}">
                                                    <i data-feather='download'></i> Excel</a>
                                            </li>
                                            {{-- <li style="margin: 2px;">
                                                <a class="btn btn-primary btn-sm" href="javascript:void(0)"
                                                    onclick="showModal(' for COD Charge','codcharge')">
                                                    <i data-feather='upload'></i> Import</a>
                                            </li> --}}
                                            <li style="margin: 2px;">
                                                <a class="btn btn-danger btn-sm"
                                                    href="{{ route('common.print', ['action' => 'pdf', 'api' => 'codcharge']) }}"
                                                    target="_blank">
                                                    <i data-feather='file'></i> PDF</a>
                                            </li>
                                            <li style="margin: 2px;">
                                                <a class="btn btn-warning btn-sm"
                                                    href="{{ route('common.print', ['action' => 'print', 'api' => 'codcharge']) }}"
                                                    target="_blank">
                                                    <i data-feather='printer'></i> Print</a>
                                            </li>
                                            <li style="margin: 2px;"><a class="btn btn-primary btn-sm"
                                                    href="{{ route('codcharge.index') }}"><i data-feather='eye'></i>
                                                    View</a></li>
                                            <li style="margin: 2px;"><a class="btn btn-dark btn-sm"
                                                    href="{{ route('codcharge.create') }}"><i data-feather='plus'></i>
                                                    Create</a></li>
                                        </ol>
                        ...
                        <div class="card-body mt-2">
                            <form class="dt_adv_search" method="POST" action="{{ route('codcharge.filter') }}">
                                @csrf
                                            ...
                                            @foreach ($getResponse as $response)
                                                <tr id="tablerow{{ $response->id }}">
                                                    ...
                                                    <td class="text-nowrap">
                                                        <a href="{{ route('codcharge.edit', $response->id) }}"><i
                                                                class="fa fa-edit"></i></a>
                                                        <a href="#"
                                                            onclick="singleDelete({{ $response->id }},'codcharges');"><i
                                                                class="fa fa-trash"></i></a>
                                                    </td>
                                                    <td><a href="#">{{ $response->percentage }}</a></td>
