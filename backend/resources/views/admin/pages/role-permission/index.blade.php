        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Role Has Permission</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item active">Role Has Permission Manage</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-sm-12">
                                        <ol class="breadcrumb float-sm-right">
                                            ...
                                            <li style="margin: 2px;"><a class="btn btn-primary btn-sm"
                                                    href="{{ route('permission.index') }}"><i data-feather='eye'></i>
                                                    View</a></li>
                                            <li style="margin: 2px;"><a class="btn btn-dark btn-sm"
                                                    href="{{ route('permission.create') }}"><i data-feather='plus'></i>
                                                    Create</a></li>
                                        </ol>
