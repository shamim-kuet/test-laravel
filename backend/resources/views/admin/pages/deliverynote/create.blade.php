                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Create Delivery Note
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                ...
                                <div class="right">
                                    <a class="btn btn-primary btn-learge" href="{{ route('deliverynote.index') }}"><i
                                            data-feather='eye'></i> View Delivery Note</a>
                                    <a class="btn btn-dark btn-learge" href="{{ route('deliverynote.create') }}"><i
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" id="modern-name" name="name" class="form-control"
                                                    value="{{ old('name') }}" placeholder="Ex: Banani, Mirpur" />
                                            </div>
                                            <div class="form-group col-md-6">
