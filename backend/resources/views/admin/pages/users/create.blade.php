                                ...
                                <div class="bs-stepper wizard-modern modern-wizard-example">
                                    ...
                                    <div class="bs-stepper-content">
                                        <div id="account-details-modern" class="content" style="margin:0">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label class="form-label" for="modern-username">Username <span
                                                            class="required">*</span></label>
                                                    <input type="text" id="username" class="form-control"
                                                        name="username" value="{{ old('username') }}" required
                                                        onkeydown="checkValidation('username','username','username_validation','Username','admins');"
                                                        onblur="checkValidation('username','username','username_validation','Username','admins')"
                                                        onkeyup="checkValidation('username','username','username_validation','Username','admins')" />

                                                    <div id="username_validation" style="padding:5px;"></div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="form-label" for="modern-email">Email<span
                                                            class="required">*</span></label>
                                                    <input type="email" id="email" class="form-control"
                                                        value="{{ old('email') }}" name="email" required
                                                        onkeydown="checkValidation('email','email','email_validation','Email','admins')"
                                                        onblur="checkValidation('email','email','email_validation','Email','admins')"
                                                        onkeyup="checkValidation('email','email','email_validation','Email','admins')" />
                                                    <div id="email_validation" style="padding: 5px"></div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-3">
                                                    <label class="form-label" for="roll">Role<span
                                                            class="required">*</span></label>
                                                    <select class="form-control" name="user_type" id="roll" required
                                                        onchange="getAjaxData('employeeid','role_id',this.value)">
                                                ...
                                                <div class="form-group col-md-3">
                                                    <label class="form-label" for="roll">Employee ID Prefix<span
                                                            class="required">*</span></label>
                                                    <div id="responsedata">
                                                        <select class="form-control" name="employeeid_prefix" required>
                                                            <option value="">Select Prefix</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label class="form-label" for="roll">Employee ID<span
                                                            class="required">*</span></label>
                                                    <input type="text" name="employee_id" value="{{ $empid }}"
                                                        readonly class="form-control">
                                                </div>
                                                <div class="form-group col-md-3">
                                                    <label class="form-label" for="modern-username">Status<span
                                                            class="required">*</span></label>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group form-password-toggle col-md-6">
                                                    <label class="form-label" for="c_password">Confirm Password<span
                                                            class="required">*</span></label>
                                        ...
                                        <div id="personal-info-modern" class="content" style="margin:0">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label class="form-label" for="modern-first-name">Name<span
                                                            class="required">*</span></label>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label class="form-label" for="modern-first-name">Emergency
                                                        Contact<span class="required">*</span></label>
                                                    <input type="text" id="modern-first-name" class="form-control"
                                                        name="emargency_contact" value="{{ old('emargency_contact') }}"
                                                        required />
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="form-label" for="phone">Designation<span
                                                            class="required">*</span></label>
                                                    <input type="text" id="emargency_contact" class="form-control"
                                                        name="designation" value="{{ old('designation') }}" required />
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label class="form-label" for="modern-first-name">Date of
                                                        Birth</label>
                                                    <input type="date" id="modern-first-name" class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label class="form-label" for="modern-first-name">Marital Status:
                                                    </label>
                                                    <input type="radio" name="marital_status" value="Married"
                                                        id="married" /> <label for="married"
                                                        class="radiolabel">Married</label>
                                                    <input type="radio" name="marital_status" value="Munmrried"
                                                        id="unmarried" /> <label for="unmarried"
                                                        class="radiolabel">Unmarried</label>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="form-label" for="phone">Gender: </label>
                                                    <input type="radio" name="gender" value="Male"
                                                        id="male" /> <label for="male"
                                                        class="radiolabel">Male</label>
                                                    <input type="radio" name="gender" value="Female"
                                                        id="female" /> <label for="female"
                                                        class="radiolabel">Female</label>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label class="form-label" for="modern-first-name">Joining Date:
                                                    </label>
                                        ...
                                        <div id="address-step-modern" class="content" style="margin:0">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <textarea name="present_address" id="present_address" cols="30" rows="10" class="form-control">{{ old('present_address') }}</textarea>

                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="form-label" for="permanent_address">Permanent
                                                        Address</label>
                                                    <textarea name="permanent_address" id="permanent_address" cols="30" rows="10" class="form-control">{{ old('permanent_address') }}</textarea>
                                                </div>
