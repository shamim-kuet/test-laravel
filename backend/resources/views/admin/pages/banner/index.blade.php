                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body mt-2">
                            <form class="dt_adv_search" method="POST" action="{{ route('banner.filter') }}">
                                @csrf
                                            ...
                                            @foreach ($getResponse as $response)
                                                <tr id="tablerow{{ $response->id }}">
                                                    ...
                                                    <td class="text-nowrap">
                                                        @if (session()->get('role_id') == 34 || \Utility::checkPermission('banner.edit'))
                                                            <a href="{{ route('banner.edit', $response->id) }}"><i
                                                                class="fa fa-edit"></i></a>
                                                        @endif
                                                        @if (session()->get('role_id') == 34 || \Utility::checkPermission('banner.destroy'))
                                                            <a href="#"
                                                                onclick="singleDelete({{ $response->id }},'banners');"><i
