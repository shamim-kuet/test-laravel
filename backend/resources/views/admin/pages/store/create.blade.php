                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                ...
                                <div class="right">
                                    <a class="btn btn-primary btn-learge" href="{{ route('store.index') }}"><i
                                            data-feather='eye'></i> View Store</a>
                                    <a class="btn btn-dark btn-learge" href="{{ route('store.create') }}"><i
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="email" id="email" name="email" class="form-control"
                                                    value="{{ old('email') }}"
                                                    onkeydown="checkValidation('email','email','email_validation','Email','stors');"
                                                    onblur="checkValidation('email','email','email_validation','Email','stors')"
                                                    onkeyup="checkValidation('email','email','email_validation','Email','stors')" />
                                            ...
                                            <div class="form-group col-md-6">
                                                <label class="form-label" for="modern-username">District<span
                                                ...
                                                <select name="region" class="form-control select2" required
                                                    ...
                                                    @foreach ($district as $distr)
                                                        <option value="{{ $distr->district_id }}">
                                                            {{ ucfirst(strtolower($distr->district_name)) }}</option>
                                                    @endforeach
                                                </select>
                                            </div>

                                            <div class="form-group col-md-6">
                                                <label class="form-label" for="modern-username">Thana/Upazila<span
                                                        class="required">*</span></label>
                                                <div id="upazilalists">
                                                    <select name="area" class="form-control select2" required>
                                                        @foreach ($upozila as $upaz)
                                                            <option value="{{ $upaz->upozila_id }}">
                                                                {{ ucfirst(strtolower($upaz->upozila_name)) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
