                ...
                <div class="col-12">
                    <div class="card">
                                        ...
                                        <ol class="breadcrumb float-sm-right">
                                            <li style="margin: 2px;">
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('common.export', ['extension' => 'csv', 'type' => 'generalsetting']) }}">
                                                    <i data-feather='file-text'></i> CSV</a>
                                            </li>
                                            <li style="margin: 2px;">
                                                <a class="btn btn-secondary btn-sm"
                                                    href="{{ route('common.export', ['extension' => 'xlsx', 'type' => 'generalsetting']) }}">
                                                    <i data-feather='download'></i> Excel</a>
                                            </li>
                                            {{-- <li style="margin: 2px;">
                                                <a class="btn btn-primary btn-sm" href="javascript:void(0)"
                                                    onclick="showModal(' for General Setting','generalsetting')">
                                                    <i data-feather='upload'></i> Import</a>
                                            </li> --}}
                                            <li style="margin: 2px;">
                                                <a class="btn btn-danger btn-sm"
                                                    href="{{ route('common.print', ['action' => 'pdf', 'api' => 'generalsetting']) }}"
                                                    target="_blank">
                                                    <i data-feather='file'></i> PDF</a>
                                            </li>
                                            <li style="margin: 2px;">
                                                <a class="btn btn-warning btn-sm"
                                                    href="{{ route('common.print', ['action' => 'print', 'api' => 'generalsetting']) }}"
                                                    target="_blank">
                                                    <i data-feather='printer'></i> Print</a>
                                            </li>
                                            <li style="margin: 2px;"><a class="btn btn-primary btn-sm"
                                                    href="{{ route('generalsetting.index') }}"><i data-feather='eye'></i>
                                                    View</a></li>
                                            {{-- <li style="margin: 2px;"><a class="btn btn-dark btn-sm"
                                                    href="{{ route('generalsetting.create') }}"><i data-feather='plus'></i>
                                                    Create</a></li> --}}
                                        </ol>
                        ...
                        <div class="card-body mt-2">
                            <form class="dt_adv_search" method="POST" action="{{ route('generalsetting.filter') }}">
                                @csrf
                                        ...
                                        @foreach ($getResponse as $response)
                                            <tr id="tablerow{{ $response->id }}">
                                                ...
                                                <td class="text-nowrap">
                                                    <a href="{{ route('generalsetting.edit', $response->id) }}">
                                                        <i data-feather='edit'></i>
                                                    </a>
                                                    {{-- <a href="#" onclick="singleDelete({{ $response->id }},'settings');">
