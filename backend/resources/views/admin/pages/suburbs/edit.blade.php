                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Create suburbs
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                ...
                                <div class="right">
                                    <a class="btn btn-primary btn-learge" href="{{ route('suburbs.index') }}"><i
                                            data-feather='eye'></i> View Suburbs</a>
                                    <a class="btn btn-dark btn-learge" href="{{ route('suburbs.create') }}"><i
                        ...
                        <section class="modern-horizontal-wizard card bg-light">
                            <div class="bs-stepper wizard-modern modern-wizard-example">
                                ...
                                <form action="{{ route('suburbs.update', $codcharge->id) }}" method="post"
                                    enctype="multipart/form-data" files="true">
                                    @csrf
                                    <div class="bs-stepper-content">
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                <label class="form-label" for="modern-username">Suburbs</label>
                                                <select class="form-control" name="suburbs">
                                                    @foreach ($suburban as $sub)
                                                        <option {{$codcharge->suburbs==$sub->upozila_id?'selected':''}} value="{{ $sub->upozila_id }}" >{{ $sub->upozila_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
