                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Create Delivery Status
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <section class="modern-horizontal-wizard card bg-light">
                            <div class="bs-stepper wizard-modern modern-wizard-example">
                                ...
                                <form action="{{ route('deliverystatus.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="bs-stepper-content">
                                            <div class="row">
                                                <div class="form-group col-md-4">
                                                    <label class="form-label" for="modern-username">Status in Admin Panel</label>
                                                    <input type="text" id="modern-name" name="name" class="form-control" value="{{ old('name') }}" placeholder="Ex: delivered" required/>
                                                </div>
                                                <div class="form-group col-md-4">
                                                    <label class="form-label" for="modern-username">Status in Merchant</label>
                                                    <input type="text" id="modern-name" name="merchant_status" class="form-control" value="{{ old('merchant_status') }}" placeholder="Ex: Pending"/>
                                                </div>
                                                <div class="form-group col-md-4">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label class="form-label" for="modern-username">Font Color</label>
                                                    <input type="color" id="modern-name" name="color" class="form-control" value="{{ old('color') }}"/>
                                                </div>
