                    ...
                    <div class="col-12">
                        ...
                        <section class="modern-horizontal-wizard card bg-light">
                            <div class="bs-stepper wizard-modern modern-wizard-example">
                                ...
                                <form action="{{ route('order.store') }}" method="POST" enctype="multipart/form-data" id="basic-form">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-8">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input id="customer_mobile" name="customer_mobile"
                                                                class="form-control" value="{{ old('customer_mobile') }}" type="number" />
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select class="form-control" name="time" id="time">
                                                                ...
                                                                <option value="Same Day Delivery">Same Day Delivery
                                                                </option>
                                                            </select>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3 col-12 mb-1">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" name="delivery_plan_id"
                                                                    id="delivery_plan_id" class="form-control" required />
                                                                <input type="hidden" name="return_plan_id"
                                                                    id="return_plan_id" class="form-control"
                                                                    value="0" />
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-12 mb-1">
                                                        ...
                                                        <div class="form-group col-md-3">
                                                            <label class="form-label" for="modern-username">Amount to be
                                                                collect</label>
                                                            <input type="number" id="collectable_amount"
                                                                name="collectable_amount" class="form-control"
                                                                value="{{ old('collectable_amount') }}" placeholder="0"
                                                                onchange="getPlanPrice();" onblur="getPlanPrice()"
                                                                onkeyup="getPlanPrice()">
                                                        </div>

                                                        <div class="form-group col-md-3">
                                                            <label class="form-label"
                                                                for="modern-username">Weights</label>
                                                            <input type="number" min="0" step="0.0001"
                                                                id="weight" name="weight" min="1"
                                                                class="form-control" onkeyup="getWeight()">
                                                        </div>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label class="form-label" for="modern-username">Delivery
                                                                Address</label>
                                                            <textarea id="customer_address" name="customer_address" class="form-control">{{ old('customer_address') }}</textarea>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4 col-12 mb-1">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-3">
                                                                        <input type="radio" name="partialdelivery"
                                                                            checked onclick="checkPartialDelivery(0)"
                                                                            value="0"
                                                                            style="width:20px; height:20px; position:absolute;" />
                                                                        <label
                                        ...
                                        <div class="col-md-4">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <input type="hidden" id="total_return_cost"
