        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Hub Assigned List</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                                <li class="breadcrumb-item active">Hub Assigned List</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                                    ...
                                    <div class="col-sm-12">
                                        <ol class="breadcrumb float-sm-right">
                                            ...
                                            @foreach ($status as $a)
                                                @if ($a->id == 28)
                                                    <li style="margin: 2px;">
                                                        <a class="btn btn-sm" style="background: {{ $a->color }}; color: {{$a->font_color}}"
                                                            href="javascript:void()"
                                                            onclick="permissions('delivery_management','{{ $a->id }}');"><i
                                            ...
                                            {{-- <li style="margin: 2px;">
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('common.export', ['extension' => 'csv', 'type' => 'cashRecivedList']) }}">
                                                    <i data-feather='file-text'></i> CSV</a>
                                            </li>
                                            <li style="margin: 2px;">
                                                <a class="btn btn-secondary btn-sm"
                                                    href="{{ route('common.export', ['extension' => 'xlsx', 'type' => 'cashRecivedList']) }}">
                                                    <i data-feather='download'></i> Excel</a>
                                            </li>

                                            <li style="margin: 2px;">
                                                <a class="btn btn-danger btn-sm"
                                                    href="{{ route('common.print', ['action' => 'pdf', 'api' => 'delivery/deliveryCashRecivedList']) }}"
                                                    target="_blank">
                                                    <i data-feather='file'></i> PDF</a>
                                            </li>
                                            <li style="margin: 2px;">
                                                <a class="btn btn-warning btn-sm"
                                                    href="{{ route('common.print', ['action' => 'print', 'api' => 'delivery/deliveryCashRecivedList']) }}"
                                                    target="_blank">
                                                    <i data-feather='printer'></i> Print</a>
                                            </li>
                                            <li style="margin: 2px;"><a class="btn btn-primary btn-sm"
                                                href="{{ route('deliveryCashRecivedList') }}"><i data-feather='eye'></i>
                                                View</a></li> --}}
                                        </ol>
                                    </div>
                                </div>
                        ...
                        {{-- <div class="card-body mt-2">
                            <form class="dt_adv_search" method="POST" action="{{ route('deliveryCashRecived.filter') }}">
                                @csrf
                                            ...
                                            <div class="col-lg-2">
                                                ...
                                                <select class="form-control" name="merchant_id" id="merchant_id">
                                                    ...
                                                    @foreach ($merchants as $merchant)
                                                        <option value="{{ $merchant->id }}">{{ @$merchant->business->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
