                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Rider Delivery Report</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                                        ...
                                        <ol class="breadcrumb float-sm-right">
                                            <li style="margin: 2px;">
                                                <a class="btn btn-info btn-sm"
                                                    href="{{ route('common.export', ['extension' => 'csv', 'type' => 'rider_delivery_report', 'requestdata'=> Request::except('_token','csrf-token','submit')]) }}">
                                                    <i data-feather='file-text'></i> CSV</a>
                                            </li>
                                            <li style="margin: 2px;">
                                                <a class="btn btn-secondary btn-sm"
                                                    href="{{ route('common.export', ['extension' => 'xlsx', 'type' => 'rider_delivery_report', 'requestdata'=> Request::except('_token','csrf-token','submit')]) }}">
                                                    <i data-feather='download'></i> Excel</a>
                                            </li>

                                            <li style="margin: 2px;">
                                                <a class="btn btn-danger btn-sm"
                                                    href="{{ route('common.print', ['action' => 'pdf', 'api' => 'riderDeliveryReport-filter','method'=>'POST','requestdata'=> Request::except('_token','csrf-token','submit')]) }}"
                                                    target="_blank">
                                                    <i data-feather='file'></i> PDF</a>
                                            </li>
                                            <li style="margin: 2px;">
                                                <a class="btn btn-warning btn-sm"
                                                    href="{{ route('common.print', ['action' => 'print', 'api' => 'riderDeliveryReport-filter','method'=>'POST','requestdata'=> Request::except('_token','csrf-token','submit')]) }}"
                                                    target="_blank">
                        ...
                        <div class="card-body mt-2">
                            <form class="dt_adv_search" method="POST" action="{{ route('rider_delivery_report.filter') }}">
                                @csrf
