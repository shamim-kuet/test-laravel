            ...
            <section class="tooltip-validations" id="tooltip-validation">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="" action="{{ route('complaint.update', $complaint->id) }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="merchant_id" class="form-control">
                                                    @foreach ($merchants as $merchant)
                                                        <option value="{{ $merchant->id }}" {{ $complaint->merchant_id==$merchant->id?'selected' : '' }}>{{ $merchant->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="rider_id" class="form-control">
                                                    @foreach ($riders as $rider)
                                                        <option value="{{ $rider->id }}" {{ $complaint->rider_id==$rider->id?'selected' : '' }}>{{ $rider->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="purpose" class="form-control">
                                                    @foreach ($complaint_puropse as $puropse)
                                                        <option value="{{ $puropse->name }}" {{ $complaint->purpose==$puropse->name?'selected' : '' }}>{{ $puropse->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-xl-4 col-md-6 col-12 mb-1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Name"
                                                    id="message" name="message" value="{{ $complaint->message }}">
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-md-6 col-12 mb-1">
                                            <div class="form-group">
