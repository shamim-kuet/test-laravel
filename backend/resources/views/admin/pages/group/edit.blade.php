                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                ...
                                <div class="right">
                                    ...
                                    <a class="btn btn-dark btn-learge" href="{{ route('group.create') }}"><i data-feather='plus'></i> Create</a>
                                </div>
                            </div>
                        ...
                        <section class="modern-horizontal-wizard card bg-light">
                            <div class="bs-stepper wizard-modern modern-wizard-example">
                                ...
                                <form action="{{ route('group.update', $group->id) }}" method="post" enctype="multipart/form-data" files="true">
                                    @csrf
                                    <div class="bs-stepper-content">
                                        <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label class="form-label" for="modern-username">Group Name</label>
                                                    <input type="text" id="modern-username" name="name" class="form-control" value="{{ $group->name }}"
