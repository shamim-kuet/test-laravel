                                        ...
                                        <div id="account-details-modern" class="content m-0">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" id="modern-username" name="username" class="form-control" value="{{ $partner->username}}"
                                        ...
                                        <div id="personal-info-modern" class="content m-0">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" id="modern-first-name" name="legal_name" class="form-control" placeholder="Nextgen IT LTD" value="{{ $partner->legal_name}}"/>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label class="form-label" for="modern-first-name">Company Name</label>
                                                    <input type="text" id="modern-first-name" name="company_name" class="form-control" placeholder="Nextgen IT" value="{{ $partner->company_name}}"/>
                                                </div>
                                                <div class="form-group col-md-12">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" id="modern-last-name" name="company_phone" class="form-control" placeholder="017XXXXXX" value="{{ $partner->company_phone}}"/>
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label class="form-label" for="modern-last-name">Company Email</label>
                                                    <input type="email" id="modern-last-name" name="company_email" class="form-control" placeholder="example@nextgenitltd.com" value="{{ $partner->company_email}}"  />
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label class="form-label" for="modern-last-name">Office Address</label>
                                                    <input type="text" id="modern-last-name" name="address" class="form-control" placeholder="Address" value="{{ $partner->address}}"/>
                                                </div>
                                            </div>
