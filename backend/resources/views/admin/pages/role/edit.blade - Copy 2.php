                            ...
                            <div id="account-details-modern" class="content m-0">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="modern-username" name="username" class="form-control"
                                ...
                                <div class="row">
                                    <div class="form-group form-password-toggle col-md-6">
                                        ...
                                        <input name="password" type="password" id="modern-password" class="form-control"
                                            placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" />
                                    </div>
                                    <div class="form-group form-password-toggle col-md-6">
                                        <label class="form-label" for="modern-confirm-password">Confirm Password</label>
                                        <input name="password_confirmation" type="password" id="modern-confirm-password"
                                            class="form-control"
                                            placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" />
                                    </div>
                                </div>
                            ...
                            <div id="personal-info-modern" class="content m-0">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="modern-first-name" name="legal_name"
                                            class="form-control" placeholder="Nextgen IT LTD"
                                            value="{{ $partner->legal_name }}" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label class="form-label" for="modern-first-name">Company Name</label>
                                        <input type="text" id="modern-first-name" name="company_name"
                                            class="form-control" placeholder="Nextgen IT"
                                            value="{{ $partner->company_name }}" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label class="form-label" for="modern-first-name">Company Logo</label>
                                        <input type="file" id="modern-first-name" name="logo"
                                            class="form-control" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label class="form-label" for="modern-last-name">Company Phone</label>
                                        <input type="text" id="modern-last-name" name="company_phone"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="email" id="modern-last-name" name="company_email"
                                            class="form-control" placeholder="example@nextgenitltd.com"
                                            value="{{ $partner->company_email }}" />
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label class="form-label" for="modern-last-name">Office Address</label>
                                        <input type="text" id="modern-last-name" name="address" class="form-control"
                                            placeholder="Address" value="{{ $partner->address }}" />
                                    </div>
                                </div>
                            ...
                            <div id="address-step-modern" class="content m-0">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <input name="contact_person_name" type="text" id="modern-address"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input name="contact_person_phone" type="text" id="modern-address"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input name="contact_person_email" type="text" id="modern-address"
                            ...
                            <div id="social-links-modern" class="content m-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" id="" name="subscription_expiry"
                                            class="form-control" value="{{ $partner->subscription_expiry }}">
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <button type="button" class="btn btn-primary btn-prev">
