                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                ...
                                <div class="right">
                                    <a class="btn btn-primary btn-learge" href="{{ route('merchantpayment.index') }}"><i
                        ...
                        <section class="modern-horizontal-wizard card bg-light">
                            <div class="bs-stepper wizard-modern modern-wizard-example">
                                ...
                                <form action="{{ route('merchantpayment.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="bs-stepper-content">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="number" id="modern-amount" name="amount" class="form-control"
                                                    value="{{ old('amount') }}" />
                                            </div>
                                            <div class="form-group col-md-6">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-6 banking">
                                                <label class="form-label" for="modern-username">Account Name</label>
