                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex">
                                ...
                                <div class="right">
                                    <a class="btn btn-primary btn-learge" href="{{ route('vehicletype.index') }}"><i data-feather='eye'></i> View Vehicle Type</a>
                                    <a class="btn btn-dark btn-learge" href="{{ route('vehicletype.create') }}"><i data-feather='plus'></i> Create New</a>
                                </div>
                            </div>
                        ...
                        <section class="modern-horizontal-wizard card bg-light">
                            <div class="bs-stepper wizard-modern modern-wizard-example">
                                ...
                                <form action="{{ route('vehicletype.update', $vehicletype->id) }}" method="post" enctype="multipart/form-data" files="true">
                                    @csrf
                                    <div class="bs-stepper-content">
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    <label class="form-label" for="modern-username">Vehicle Type</label>
                                                    <input type="text" id="modern-name" name="name" class="form-control" value="{{ $vehicletype->name }}" placeholder="Ex: Banani, Mirpur"/>
                                                </div>
