                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Create Hub Location
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <section class="modern-horizontal-wizard card bg-light">
                            <div class="bs-stepper wizard-modern modern-wizard-example">
                                ...
                                <form action="{{ route('hublocation.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="bs-stepper-content">
                                            <div class="row">
                                               ...
                                               <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" id="modern-name" name="region" class="form-control" value="{{ old('region') }}"/>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" id="modern-name" name="zone" class="form-control" value="{{ old('zone') }}"/>
                                                </div>
                                                <div class="form-group col-md-6">
