...
<div class="app-content content ">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-body">
            <div class="auth-wrapper auth-v2" style="background:#f05542">
                <div class="auth-inner row m-0">
                    <!-- Brand logo-->
                    <a class="brand-logo" href="javascript:void(0);">
                    	@if($setting->logo!="")
                        	<img alt="{{ $setting->site_name }}" src="{{ asset('uploads/company/logo/'.$setting->logo) }}" style="width:150px; height:auto">
                        @else
                        	<img alt="{{ $setting->site_name }}" src="{{ asset('app-assets/images/logo/whitelogo.png') }}" style="width:150px; height:auto">
                        @endif
                        <h2 class="brand-text text-white ml-1 mt-1">{{ $setting->site_name }}</h2>
                    </a>
                    <!-- /Brand logo-->
                    <!-- Left Text-->
                    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{ $setting ? $setting->default_url : '' }}app-assets/images/pages/login_banner.webp" alt="Login V2" /></div>
                    </div>
                    <!-- /Left Text-->
                    <!-- Login-->
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            <h2 class="card-title font-weight-bold mb-1">{{ $setting->site_title }}</h2>
