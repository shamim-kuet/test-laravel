                        ...
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <form class="mt-2" action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <label class="form-label text-white" for="login-email">Email / Username</label>
                                    <input id="email" placeholder="Email" type="text" class="form-control @error('email') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="email" autofocus>
